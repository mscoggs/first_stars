...
class constants(object):
    ...
    RADIATION_SHIELD = 1 #2 is default
    MULTI_SPECIES = 1 #2 is default
    RADIATION_FIELD_TYPE = 4 #9 is default
    ...
    JOB_TIME_ENZO_HR = 11.0*(PARTICLE_DIM/N_MPI_ENZO)**3
    ...
    #TREE
    JOB_NAME_TREES = "trees"
    PARTITION_TREES = "skx"
    N_NODES_TREES = "1"
    N_MPI_TREES = "1"
    JOB_TIME_TREES = "1:00:00"
...
def main():
    ...
    if("rockstar_halos" in consts.HALO_FOLDERS):
        ...
        print("     Writing tree batch files")
        fname = consts.JOB_NAME_TREES
        replace_text(fname,"sbatch_scripts/"+fname+"_base.sh","sbatch_scripts/"+fname+".sh")
        write_sbatch(fname,consts.WORK_DIR)
